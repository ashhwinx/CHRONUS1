...
export default function Projects() {
  return (
    <section id="projects" className="projects-section relative h-[550dvh] w-full z-40 pointer-events-none">
      <div className="sticky top-0 h-[100dvh] w-full flex flex-col md:flex-row items-center md:items-center justify-center md:justify-between px-6 md:px-12 lg:px-12">
        
        {/* --- Left Side (Desktop) / Top & Bottom Stack (Mobile) --- */}
        <div className="projects-left w-full md:w-[45%] pointer-events-auto flex flex-col items-center md:items-start absolute md:relative top-[15%] md:top-auto md:-translate-y-0 z-50">
          
          {/* Top Text (Mobile: Center-top, Desktop: Left) */}
          <div className="flex flex-col font-['Impact',_Arial_Black,_sans-serif] uppercase tracking-tighter leading-[0.85] mb-4 text-center md:text-left">
             <span className="text-white text-[13vw] sm:text-7xl md:text-[5rem] lg:text-[6rem] drop-shadow-md font-black pb-1">WE <br /> MAKE THEM</span>
             <span className="text-white text-[13vw] sm:text-7xl md:text-[5.5rem] lg:text-[6.5rem] drop-shadow-md font-black">SOCIAL</span>
          </div>

          {/* Premium Glassmorphism Profiles Pill (Mobile: Moved to absolute bottom, Desktop: Normal flow) */}
          <div className="flex items-center gap-4 absolute top-[75vh] md:relative md:top-auto mt-0 md:mt-10 bg-white/5 backdrop-blur-md border border-white/10 p-2 md:p-3 rounded-full w-max shadow-2xl">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[65vw] md:w-[25vw] aspect-[2/3] max-w-[340px] pointer-events-auto z-40" style={{ transformStyle: "preserve-3d" }}>
              ...
              {project.isMore ? (
                ...
                <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-between z-10 text-white">
                  ...
                  <div className="w-full flex justify-center mt-auto pb-2">
                    <button className="w-full py-3 md:py-4 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white flex items-center justify-center gap-3 hover:bg-white hover:text-black transition-all duration-300 group/btn shadow-xl">
        ...
        <div className="about-anim-line hidden md:flex absolute bottom-8 left-6 md:bottom-12 md:left-12 lg:left-16 items-center gap-4 pointer-events-auto z-20 group cursor-pointer">
        ...
        <div className="reveal-rect absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100vw] h-[100vh] bg-[#db3c8a] flex items-center justify-center flex-col overflow-hidden px-4 text-center z-[100] will-change-transform pointer-events-auto border-y border-white/10">
          <div className="w-full max-w-6xl flex flex-col items-center justify-center gap-2 md:gap-4 font-['Impact',_Arial_Black,_sans-serif] uppercase tracking-tighter" style={{ transformStyle: "preserve-3d" }}>
            ...
            <div className="overflow-hidden">
              <h2 className="reveal-text-line text-4xl sm:text-7xl md:text-[6rem] lg:text-[7rem] font-black text-white leading-[0.85] drop-shadow-sm">
                IT IS IMPACT OF
              </h2>
            </div>
